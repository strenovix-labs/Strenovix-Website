...
const VARIANTS = {
    ...
    purple: { activeColor: '#000000', gap: 5, speed: 40, colors: '#bf9fff,#000000,#6c3fd4', noFocus: false },
};

export default function PixelCard({ variant = 'purple', gap, speed, colors, noFocus, className = '', children }) {
